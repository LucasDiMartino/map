...
#include "../inc/gtk-image-viewer-private.h"
...
#define self_zoom_in gtk_image_viewer_zoom_in
#define self_zoom_out gtk_image_viewer_zoom_out
...
#define self_set_scale_and_shift gtk_image_viewer_set_scale_and_shift
